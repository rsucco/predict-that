...
for i in range(1, numCandidates + 1):
     ...
     returnPercentage = ((guaranteedReturn / totalCost), 2)
     possiblePercentage = (((guaranteedReturn + 850.0) / totalCost))
     scenarios.append("Betting the max on the top " + str(i) + " candidates would have a total cost of " + str(totalCost) + \
         " and a guaranteed profit of " + str(guaranteedProfit) + " for a guaranteed return percentage of " + str(returnPercentage) \
